        ...
        <MainLayout>
            ...
            <div className='mx-3 flex flex-col md:flex-row justify-center'>
                ...
                <div className='w-72 mx-auto md:mx-0 md:ms-10 flex flex-col items-center'>
                    ...
                    <button className='w-full py-2 my-5 text-white bg-amber-500 rounded-lg hover:scale-105 transition-transform' onClick={() => Object.keys(cart).length > 0 && setShowConfirmModal(true)}>
                        Objednat
                    </button>
